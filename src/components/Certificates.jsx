...
const CERT_CATEGORIES = [
  {
    ...
    items: [
      ...
      { title: 'Preparation for Job Interview', asset: 'Preparation for Job Interviews.pdf' },
      { title: 'Job Interview Preparation Mastery', asset: 'Job Interview Preparation Mastery.pdf' },
      { title: 'Prepare and Practice for Interviews with AI', asset: 'Prepare and Practice for Interviews with AI.pdf' },
      { title: 'Psychology of the Self', asset: 'Psychology of the Self.pdf' },
      { title: 'Managing Conflicts with Cultural and Emotional Intelligence', asset: 'Managing Conflicts with Cultural and Emotional Intelligence.pdf' },
      { title: 'Positive Psychology: Resilience Skills', asset: 'Positive Psychology Resilience Skills.pdf' },
      { title: 'Grit and Growth Mindset', asset: 'Grit and Growth Mindset.pdf' },
      { title: 'Solving Problems with Creative and Critical Thinking', asset: 'Solving Problems with Creative and Critical Thinking.pdf' },
      { title: 'Negotiation Skills: Negotiate and Resolve Conflict', asset: 'Negotiation skills Negotiate and resolve conflict.pdf' },
    ],
  },
  {
    name: 'AI Bootcamp',
